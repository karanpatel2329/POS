...
class EAddNewItemsScreen extends StatefulWidget {
  const EAddNewItemsScreen({super.key});

  @override
  State<EAddNewItemsScreen> createState() => _EAddNewItemsScreenState();
}

class _EAddNewItemsScreenState extends State<EAddNewItemsScreen> {
  @override
    ...
    String selectedCategories = 'Veg';
     ...
     return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        color: white,
        child: AppButtonStyle.ElevatedButtonStyled('DARK', Text('SEND TO KITCHEN', style: AppTextStyle.whiteText14W600,), () {Get.to(EConfirmOrderScreen());})),
