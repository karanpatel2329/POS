...
import '../../e_start_duty/controller/e_order_controller.dart';

class EPaymentScreen extends StatefulWidget {
  const EPaymentScreen({super.key, required this.index});

  final int index;
  @override
  State<EPaymentScreen> createState() => _PaymentScreenState();
}

class _PaymentScreenState extends State<EPaymentScreen> {
