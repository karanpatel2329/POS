...
import 'package:pos_app/features/employee/e_checkout/view/e_payment_done.dart';


class ECheckoutScreen extends StatefulWidget {
  ECheckoutScreen({super.key});

  static TextEditingController nameController = TextEditingController();
  static TextEditingController phoneController = TextEditingController();

  @override
  State<ECheckoutScreen> createState() => ECheckoutScreenState();
}

class ECheckoutScreenState extends State<ECheckoutScreen> {
            ...
            child: Column(
              ...
              children: [
                ...
                ListView.builder(
                  ...
                  AppButtonStyle.ElevatedButtonStyled('DARK', Text('CONTINUE TO PAYMENT', style: AppTextStyle.whiteText14W600,), () {Get.to(EPaymentDoneScreen());})
